        ...
        {hasFullAccess && report.conversionOptimization && (
          <section className="mb-12 print:mb-8 page-break-inside-avoid">
            ...
            <div className="space-y-4">
              ...
              {report.conversionOptimization.detailedAnalysis?.conversionChecklist && Array.isArray(report.conversionOptimization.detailedAnalysis.conversionChecklist) && (
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <h4 className="font-semibold text-gray-900 mb-3">Conversion Checklist</h4>
                  <div className="space-y-2">
                    {report.conversionOptimization.detailedAnalysis.conversionChecklist.map((item, i) => (
                      <div key={i} className="flex items-start gap-2 text-sm">
                        ...
                        <span className="text-gray-700">{(item as any).item || (item as any).element || JSON.stringify(item)}</span>
                      </div>
                    ))}
                  </div>
                </div>
