...
export default function AccessReportsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      {/* Main Content */}
      <main className="px-4 py-16 md:py-24 flex items-center justify-center">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="w-full max-w-md"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-lg rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 outline-none transition-all bg-white text-gray-900 placeholder-gray-400"
                  required
                  disabled={loading}
                />
              </div>
              ...
              {error && (
                <div className="p-4 bg-red-50 border border-red-200 rounded-xl text-sm text-center">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 text-white rounded-xl font-medium transition-colors disabled:opacity-50"
