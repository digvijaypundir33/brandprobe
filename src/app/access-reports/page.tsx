        ...
        >
          ...
          <div className="p-6 sm:p-8 bg-white rounded-xl sm:rounded-2xl border-2 border-gray-200 shadow-lg">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 sm:py-3.5 bg-white border-2 border-gray-200 rounded-xl font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all"
            >
