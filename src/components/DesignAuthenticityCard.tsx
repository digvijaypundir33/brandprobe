        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-medium text-gray-800 text-sm">Cliché Phrases</h4>
            </div>
            <div className="text-2xl font-bold text-gray-900 mb-1">{analysis.clicheCount || 0}</div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-medium text-gray-800 text-sm">Layout</h4>
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-medium text-gray-800 text-sm">Icons</h4>
            </div>
          ...
          <div className="mb-6 bg-gray-50 rounded-lg p-4 border border-gray-100">
            ...
            <div className="flex flex-wrap gap-2">
              {clichePhrases.map((phrase, idx) => (
                <span
                  key={idx}
                  className="px-3 py-1 bg-gray-200 text-gray-900 rounded-full text-xs font-medium"
                >
                  &quot;{phrase}&quot;
                </span>
              ))}
        ...
        {analysis.strengthsSummary && (
          <div className="mb-6 bg-gray-50 rounded-lg p-4 border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-medium text-gray-800 text-sm">Unique Strengths</h4>
            </div>
            <p className="text-sm text-gray-600">{analysis.strengthsSummary}</p>
          </div>
        )}
