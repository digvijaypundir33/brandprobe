  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-900 p-6 text-white">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="text-2xl font-bold">{technical.score}</div>
      ...
      <div className="p-6">
        ...
        {/* Security Indicators */}
        {analysis.securityIndicators && analysis.securityIndicators.length > 0 && (
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {analysis.securityIndicators.map((indicator, i) => (
                <span
                  key={i}
        ...
        {/* Accessibility Flags */}
        {analysis.accessibilityFlags && analysis.accessibilityFlags.length > 0 && (
          <div className="mb-6">
            <h4 className="text-sm font-medium text-gray-700 mb-3 flex items-center gap-2">
              <svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-2">
              {analysis.accessibilityFlags.map((flag, i) => (
